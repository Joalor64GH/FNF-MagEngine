...
class Prefs
{
	public static function init()
	{
		...
		if (FlxG.save.data.transparentStrums == null)
			FlxG.save.data.transparentStrums = false;
	...
	public static function get(pref:String):Dynamic
	{
		return Reflect.getProperty(FlxG.save.data, pref);
	}

	public static function set(pref:String, value:Dynamic)
	{
		Reflect.setProperty(FlxG.save.data, pref, value);
	}
