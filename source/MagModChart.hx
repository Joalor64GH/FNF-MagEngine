            ...
            Lua_helper.add_callback(lua, 'getProperty', function(Var:String)
                ...
                Lua_helper.add_callback(lua, 'getPropertyFromGroup', function(obj:String, index:Int, variable:Dynamic)
                    ...
                    Lua_helper.add_callback(lua, "doTweenX", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
                        ...
                        if(fuckingshit != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(fuckingshit, {x: value}, duration, {ease: getFlxEaseByString(ease),
                    ...
                    Lua_helper.add_callback(lua, "doTweenY", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
                        var fuckingshit:Dynamic = tweenShit(tag, vars);
                        if(fuckingshit != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(fuckingshit, {y: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doTweenAngle", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
                        var fuckingshit:Dynamic = tweenShit(tag, vars);
                        if(fuckingshit != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(fuckingshit, {angle: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doTweenAlpha", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
                        var fuckingshit:Dynamic = tweenShit(tag, vars);
                        if(fuckingshit != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(fuckingshit, {alpha: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doTweenZoom", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
                        var fuckingshit:Dynamic = tweenShit(tag, vars);
                        if(fuckingshit != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(fuckingshit, {zoom: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doTweenColor", function(tag:String, vars:String, targetColor:String, duration:Float, ease:String) {
                        ...
                        if(fuckingshit != null) {
                            ...
                            currentPlaystate.modchartTweens.set(tag, FlxTween.color(fuckingshit, duration, fuckingshit.color, color, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.modchartTweens.remove(tag);
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doNoteTweenX", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
                        ...
                        if(iamcoolbro != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(iamcoolbro, {x: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doNoteTweenY", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
                        ...
                        if(iamcoolbro != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(iamcoolbro, {y: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doNoteTweenAngle", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
                        ...
                        if(iamcoolbro != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(iamcoolbro, {angle: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    Lua_helper.add_callback(lua, "doTweenTransparency", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
                        ...
                        if(iamcoolbro != null) {
                            currentPlaystate.modchartTweens.set(tag, FlxTween.tween(iamcoolbro, {alpha: value}, duration, {ease: getFlxEaseByString(ease),
                                onComplete: function(twn:FlxTween) {
                                    currentPlaystate.callOnLuas('onTweenCompleted', [tag]);
                                    currentPlaystate.modchartTweens.remove(tag);
                                }
                    ...
                    public function getCamFromString(cam:String = 'game'):FlxCamera
                        ...
                        function cameraFromString(cam:String):FlxCamera {
                            switch(cam.toLowerCase()) {
                                case 'camhud' | 'hud': return currentPlaystate.camHUD;
                            }
