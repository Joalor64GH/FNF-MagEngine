...
class ChartingState extends MusicBeatState
{
	...
	public var typinglol:FlxInputText;
	...
	**/
	...
	function addSongUI():Void
	{
		...
		#else
		var characters = CoolUtil.coolTextFile(Paths.txt('data/characterList'));
		var stages = CoolUtil.coolTextFile(Paths.txt('data/stageList'));
		var gfVersions = CoolUtil.coolTextFile(Paths.txt('data/gfVersionList'));
		var events = CoolUtil.coolTextFile(Paths.txt('data/eventList'));
		#end
		...
		{
			swagEvent = new MidSongEvent(eventsDropDown.selectedLabel, swagEvent.eventPos, typingWaste.text, typinglol.text);
	...
	function addSectionUI():Void
	{
		...
		check_altAnim = new FlxUICheckBox(10, 45, null, null, "Alt Animation", 100);
	...
	override function update(elapsed:Float)
	{
		...
		swagEvent.valueOne = typinglol.text;
