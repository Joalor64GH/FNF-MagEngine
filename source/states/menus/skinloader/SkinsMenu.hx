package states.menus.skinloader;

import states.menus.skinloader.SkinList;
import states.menus.skinloader.SkinHandler;
import states.menus.skinloader.SkinMenuOption;
...
class SkinsMenu extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		{
			MusicBeatState.switchState(new states.menus.skinloader.SkinDownloadState());
		}
		#end
